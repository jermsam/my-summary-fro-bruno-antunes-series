...
exports.getMakes = exports.authorized = exports.getAuthId = exports.getCookie = exports.myGet = exports.authenticated = exports.apiEndpoint = void 0;
...
exports.authorized = function (fn) { return function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var cookie, jwt, sub, ownerId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                cookie = req === null || req === void 0 ? void 0 : req.headers.cookie;
                jwt = getCookie('auth', cookie);
                if (!jwt) return [3 /*break*/, 4];
                sub = jwt_decode_1["default"](jwt).sub;
                ownerId = req === null || req === void 0 ? void 0 : req.query.ownerId;
                if (!(sub.toString() === ownerId)) return [3 /*break*/, 2];
                return [4 /*yield*/, fn(req, res)];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
